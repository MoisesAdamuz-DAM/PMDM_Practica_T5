            ...
            public void onClick(View v, int position ) {
                ...
                switch(v.getId())
                {
                    ...
                    case R.id.nombreSerie:
                        ...
                        serieDetalles.putExtra("imgEstrellaSerie", items.get(position).getCalificacion());
