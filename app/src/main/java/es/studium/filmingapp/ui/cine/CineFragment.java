...
public class CineFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        items.add(new Cine(R.drawable.retorno, "El Señor de los Anillos: El Retorno del Rey", "Peter Jackson","Gandalf: Ian Mckellen, Aragorn: Viggo Mortensen, Frodo Bolsón: Elijah Wood ","Hombres, elfos y enanos unen sus fuerzas para presentar batalla a Sauron y sus huestes. Ajenos a estos preparativos, Frodo y Sam siguen adentrándose en el país de Mordor en su heroico viaje para destruir el Anillo de Poder en las Grietas del Destino."));
